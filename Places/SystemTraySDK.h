...
public:
	...
	// menu
	void CheckMenuItem(UINT uIDItem, bool checked);
	void EnableMenuItem(UINT uIDItem, bool enabled);
...
protected:
    ...
    HWND            m_hWnd;
	HMENU			m_hMenu;			// the popup menu, which is a submenu of a parent menu
	HMENU			m_hMainMenu;		// its parent menu
